<?php
    ...
    function main(){
        ...
        $sql = "SELECT adminID, adminEmail, adminPassword FROM administrator WHERE adminEmail = :email";
        ...
        if ($stmt->rowCount()>0){
            ...
            if (verifyPassword($enteredPassword, $user["adminPassword"])) {
